<nav class="top-0 z-10 overflow-hidden flex flex-col flex-wrap content-center justify-between w-56 h-full bg-neutral-900 p-4 font-normal text-sm border-neutral-600 border-r shadow-lg">
